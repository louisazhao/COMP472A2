public class Main {
    ...
    public static void main(String[] args) {
        ...
        DecisionTreeJ48 decisionTreeData1 = new DecisionTreeJ48(trainingData1, validationData1,testSet1);
        //comment out the following line to see the saved model actually works, you need to run the line at least once
        decisionTreeData1.trainAndSaveModel("OutputFiles/ds1/decisionTree1.model", 0.2f, 3);
        ...
        RandomForestML randomForestData1 = new RandomForestML(trainingData1, validationData1, testSet1);
        //comment out the following line to see the saved model actually works, you need to run the line at least once
        randomForestData1.trainAndSaveModel("OutputFiles/ds1/randomForest1.model");
        randomForestData1.evaluateModelWithValidationSet("OutputFiles/ds1/randomForest1.model", "OutputFiles/ds1/ds1Val-rf.csv");
        randomForestData1.classifyNewData("OutputFiles/ds1/randomForest1.model", "OutputFiles/ds1/ds1Test-rf.csv");
        ...
        DecisionTreeJ48 decisionTreeData2 = new DecisionTreeJ48(trainingData2, validationData2,testSet2);
        //comment out the following line to see the saved model actually works, you need to run the line at least once
        decisionTreeData2.trainAndSaveModel("OutputFiles/ds2/decisionTree2.model", 0.1f, 4);
